...
@Service
// TODO: add more methods here for deleteCharacter, findCharacterByName, findAllCharacter
public class CharacterService {
    ...
    public String saveCharacter(CharacterDTO characterDTO) {
        Character character = new Character(characterDTO.getEyeColor(), characterDTO.getBirthYear());
        characterRepository.save(character);
        return "Successfully saved the entity in the database table";
    }
